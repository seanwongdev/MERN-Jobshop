...
function Button({ children, onClick, type, disabled, to }) {
  const styles = {
    primary:
      "bg-primary rounded-md text-bright px-3.5 py-1.5 shadow hover:bg-secondary hover:text-bright border-0 focus:outline-0",
    secondary:
    ...
    dark: "bg-secondary hover:bg-dark hover:text-bright rounded-md text-bright w-auto py-2 px-4 transition border-0 focus:outline-0",
  };
